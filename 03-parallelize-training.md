...
with open("/p/scratch/training2340/data/train_data.pkl", "wb") as f:
    pickle.dump(data, f)
```
...
```python
root = "/p/scratch/training2340/data/"
...
# 1. Organize the data
datamodule = ImageNetDataModule("/p/scratch/training2340/data/", 256, \
...
nnodes = os.getenv("SLURM_NNODES")
# 2. Organize the data
datamodule = ImageNetDataModule("/p/scratch/training2340/data/", 128, \
    int(os.getenv('SLURM_CPUS_PER_TASK')), transform)
